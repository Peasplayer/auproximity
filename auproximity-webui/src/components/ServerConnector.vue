...
export default class ServerConnector extends Vue {
  ...
  get shareSlug () {
    if (this.backendType === BackendType.Impostor || this.backendType === BackendType.Peasplayer) {
      return location.origin + '/' + BackendType[this.backendType] + '/' + 'au.peasplayer.tk' + '/' + this.gameCode.toUpperCase()
